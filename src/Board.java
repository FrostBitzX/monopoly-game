...
public class Board {
    ...
    public Board() {
        ...
        squares.add(new Square("Go",0,-1)); //start
        squares.add(new Square("GSB @BTS Kaset",1,80)); //ธนาคารออมสิน bts เกษตร
        squares.add(new Square("Community Chest",2,-1));
        squares.add(new Square("Kaset Hall",3,120)); //หอประชุม
        squares.add(new Square("Income Tax",4,-1));
        ...
        squares.add(new Square("Chance",7,-1));
        ...
        squares.add(new Square("Jail / Just Visiting",10,-1));
        ...
        squares.add(new Square("Community Chest",17,-1));
        ...
        squares.add(new Square("Free Parking",20,-1));
        squares.add(new Square("Tennis Court",21,80)); //สนามเทนนิส
        squares.add(new Square("Chance",22,-1));
        ...
        squares.add(new Square("Go To Jail",30,-1));
